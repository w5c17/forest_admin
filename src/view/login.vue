    ...
    <div class="container mx-auto h-full flex flex-1 justify-center items-center">
      <div class="relative mx-10 sm:max-w-sm w-full">
        ...
        <div class="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md">
          ...
          <form class="mt-10">
            <div class="relative">
              <input placeholder="请输入账号或邮箱" class="mt-1 pl-2 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0" />
            </div>

            <div class="mt-7 relative">
              <input type="password" placeholder="请输入密码" class="mt-1 pl-2 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0" />
            </div>
